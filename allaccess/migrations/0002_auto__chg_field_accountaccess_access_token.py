...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AccountAccess.access_token'
        db.alter_column('allaccess_accountaccess', 'access_token', self.gf('allaccess.fields.EncryptedField')(null=True))

    def backwards(self, orm):

        # Changing field 'AccountAccess.access_token'
        db.alter_column('allaccess_accountaccess', 'access_token', self.gf('django.db.models.fields.TextField')())
